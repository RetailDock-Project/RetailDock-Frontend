...
const Dashboard: React.FC = () => {
  const { data: accoutStats } = useQuery({
    queryKey: ["accoutStats"],
    queryFn: getAccountsStatusSummary,
    select: (res) => res.data,
  });
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <MetricCard
            ...
            value={dashboardSummary?.amountReceivedThisMonth}
            icon={<CreditCard className="w-5 h-5 text-purple-600" />}
            iconBg="bg-purple-100"
          />
          <MetricCard
            title="Current Year Revenue"
            value={dashboardSummary?.amountReceivedThisYear}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <div className="flex justify-between text-sm font-medium text-gray-700 mb-1">
                ...
                <span>{accoutStats?.activeCount}</span>
              </div>
            ...
            <div>
              <div className="flex justify-between text-sm font-medium text-gray-700 mb-1">
                ...
                <span>{accoutStats?.inactiveCount}</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div
            ...
            {/* <div>
              <div className="flex justify-between text-sm font-medium text-gray-700 mb-1">
                <span>Registered Users (No Organization)</span>
                <span>38</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div
            ...
            <div>
              <div className="flex justify-between text-sm font-medium text-gray-700 mb-1">
                ...
                <span>{accoutStats?.expiredCount}</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div
